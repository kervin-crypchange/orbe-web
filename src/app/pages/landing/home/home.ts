...
import { AnswerPath, Asesores, Comments, Discover, DownloadApp, Header, Wallet, WhatsIs } from '@core/landing/sections';
...
@Component({
  selector: 'app-home',
  imports: [Header, WhatsIs, AnswerPath, DownloadApp, Discover, Wallet, Asesores, Comments],
